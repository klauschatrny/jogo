...
## O 3º campo separa LIÇÃO (vale reler nas Opções) de ORIENTAÇÃO do momento. Só LIÇÕES de combate
## aqui — nada de direções ("vá para tal porta"): o jogador explora por conta própria.
static func entries() -> Array:
	return [
		...
		[840.0,  "Ataque com  %s  e teste no boneco" % KeyBinds.key_name("attack"), true],
...
static func flask_tip() -> String:
	return "Frasco de Cura: beba com %s. Recarrega ao despertar" \
